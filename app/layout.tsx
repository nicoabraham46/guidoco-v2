    ...
    <html lang="es">
      ...
      >
        <CartProvider>
          ...
          {/* ── Header principal ── */}
          <header className="sticky top-0 z-40 border-b border-zinc-800/60 bg-zinc-950/95 backdrop-blur-md" style={{ position: "relative", overflow: "hidden" }}>
            <PokemonRunner />
              ...
              <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <ul className="mt-4 space-y-3">
                    ...
                    <li>
                      <a
                        href="mailto:nicoabraham001@gmail.com"
                        className="flex items-center gap-2.5 text-sm text-zinc-400 transition-colors hover:text-white"
                      >
